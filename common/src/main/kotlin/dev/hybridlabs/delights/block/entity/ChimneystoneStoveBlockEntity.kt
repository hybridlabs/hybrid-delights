...
class ChimneystoneStoveBlockEntity(pos: BlockPos, state: BlockState) :
    AbstractStoveBlockEntity(HDBlockEntityTypes.CHIMNEYSTONE_STOVE.get(), pos, state, RecipeType.CAMPFIRE_COOKING) {
