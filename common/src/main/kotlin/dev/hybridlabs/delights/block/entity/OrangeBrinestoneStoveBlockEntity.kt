...
class OrangeBrinestoneStoveBlockEntity(pos: BlockPos, state: BlockState) :
    AbstractStoveBlockEntity(HDBlockEntityTypes.ORANGE_BRINESTONE_STOVE.get(), pos, state, RecipeType.CAMPFIRE_COOKING) {
