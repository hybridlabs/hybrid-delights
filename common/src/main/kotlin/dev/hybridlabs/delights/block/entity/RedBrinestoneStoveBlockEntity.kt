...
class RedBrinestoneStoveBlockEntity(pos: BlockPos, state: BlockState) :
    AbstractStoveBlockEntity(HDBlockEntityTypes.RED_BRINESTONE_STOVE.get(), pos, state, RecipeType.CAMPFIRE_COOKING) {
